...
@class AppDelegate;
@class RemoteForAndroidTV_BonjourServiceDiscovery;
...
@interface RemoteForAndroidTV_BonjourServiceDiscovery : NSObject<NSNetServiceBrowserDelegate, NSNetServiceDelegate> {
}
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
